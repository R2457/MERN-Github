    ...
    return (
        <li className='mb-10 ms-7'>
			...
			<div className='flex gap-2 items-center flex-wrap'>
				<a
					href={"https://github.com/R2457/fitconnect"}
					target='_blank'
					rel='noreferrer'
			...
			<p className='mb-4 text-base font-normal text-gray-500'>Gym Slot Booking App | Java && Spring Boot && Angular && JWT</p>
			<img src={"/java.svg"} alt='Programming language icon' className='h-8' />
		</li>
    );
};
export default Repo;